...
export const CreateRoleForm = ()=>{
    ...
    return (
        <section className="flex flex-col">
            <h2 className="border-2 font-bold self-center w-80 text-center text-2xl m-1 p-1 rounded-lg border-theme text-theme">Agrega un nuevo role</h2>
            <section className="flex flex-col gap-1">
                <div className='flex flex-col self-center w-80'>
                    <label className='font-bold text-theme bg-white p-1 ml-2 relative top-4 w-[8.25rem] z-10'>Nombre del role</label>
                    <input
                        name='roleName'
                        value={roleName}
                        ref={roleNameRef}
                ...
                <div className='flex flex-col self-center w-80'>
                    ...
                    <textarea
                        ...
                        className='focus:outline-orange-300 focus:scale-[1.02] border-2 border-theme rounded-lg h-24 pl-2 font-bold text-black/50 pt-2'/>
                </div>
            <div className='flex flex-col self-center w-80'>
                <label className='font-bold text-theme bg-white p-1 ml-2 relative top-4 w-[10.1rem] z-10'>Permisos de usuario</label>
                <select
                name='permissions'
                onChange={onInputChange}
                ref={permissionsRef}
            ...
            className={
                ...
                w-80 font-bold text-xl m-1 self-center h-10 border-2 rounded-lg text-white hover:scale-[1.02]`
            }>Agregar role</button>
           { created !== false && (
